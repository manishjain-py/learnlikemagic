...
from models import TeachingGuideline, GuidelineMetadata, GuidelineResponse, SubtopicInfo
...
class TeachingGuidelineRepository:
    ...
    def get_guideline(
        ...
        if guideline.metadata_json:
            try:
                metadata_dict = json.loads(guideline.metadata_json)
                metadata = GuidelineMetadata(**metadata_dict)

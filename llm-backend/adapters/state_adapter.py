...
from models import TutorState, HistoryEntry, GradingResult, StudentPrefs
...
class StateAdapter:
    ...
    def simplified_to_tutor_state(
        ...
        step_idx = StateAdapter._calculate_step_idx(simplified_state)

        # Calculate mastery score from evaluation results
        mastery_score = StateAdapter._calculate_mastery_score(simplified_state)

        # Extract last grading from conversation/assessment
        last_grading = StateAdapter._extract_last_grading(simplified_state)

...
- **Phone number** — Tap "Continue with Phone", enter your number, receive an OTP code, verify it
...
2. Pick your country code (+91 India, +1 US, +44 UK, +61 Australia)
3. Enter your phone number
4. Receive an OTP code via SMS
5. Enter the 6-digit code (one digit per box — it submits automatically when all 6 are filled)
6. You're signed in

Phone signup and login are the same flow — entering your phone number creates an account if one doesn't exist.
